...
![](https://latex.codecogs.com/png.image?\dpi{110}%20kMM_{i,%20mn}=P_{i}\left(O_{m}\rightarrow%20O_{n}\right)=\frac{F_{i}\left(O_{m}\rightarrow%20O_{n}\right)}{F_{i}\left(O_{m}\right)}=\sum_{b%20\in%20\{\text{A,G,C,T}\}}\frac{F_{i}\left(O_{m}\rightarrow%20O_{n}\right)}{F_{i}\left(O_{m}\rightarrow%20O_b\right)})
...
![](https://latex.codecogs.com/png.image?\dpi{110}%20\begin{align*}S_{i}%20&=-\sum_{j=0}^{l-k-1}%20\ln%20\left%28P_{i}\left%28O_{j}%20\rightarrow%20O_{j+1}\right%29\right%29\\&=-\sum_{mn\in%20%28k+1%29mer}f_i%28O_m\rightarrow%20O_n%29\ln%28P_{i}%28O_{m}\rightarrow%20O_{n}%29%29\\&=-\sum_{mn\in%20%28k+1%29mer}f_i%28O_m\rightarrow%20O_n%29\ln%28\sum_{b%20\in%20\{\text{A,G,C,T}\}}\frac{F_{i}\left%28O_{m}\rightarrow%20O_{n}\right%29}{F_{i}\left%28O_{m}\rightarrow%20O_b\right%29}%29\end{align*})
